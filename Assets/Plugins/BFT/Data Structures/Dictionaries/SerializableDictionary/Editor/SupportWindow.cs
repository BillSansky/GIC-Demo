...
namespace BFT
{
    public class SupportWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            myWindow.assetName =
                myWindow.IconContent("<size=20><b><color=#AAAAAA> Serializable Dictionary</color></b></size>", "", "");
            myWindow.support =
                myWindow.IconContent(
                    "<size=12><b> Support</b></size>\n <size=9>Get help and talk \n with others.</size>", "_Help", "");
            myWindow.contact =
                myWindow.IconContent("<size=12><b> Contact</b></size>\n <size=9>Reach out and \n get help.</size>",
                    "console.infoicon", "");
            myWindow.review =
                myWindow.IconContent("<size=11><color=white> Please consider leaving a review.</color></size>",
                    "Favorite Icon", "");
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button(review, ReviewBanner, GUILayout.Height(30)))
                Application.OpenURL(
                    "https://www.assetstore.unity3d.com/en/#!/account/downloads/search=Serialized%20Dictionary");
        }
