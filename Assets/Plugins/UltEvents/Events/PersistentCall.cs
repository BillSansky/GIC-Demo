...
namespace UltEvents
{
...
#endif
    {
            ...
            else
            {
                ...
                if (target != null)
                    ...
                    throw new InvalidOperationException(
                        "SetMethod failed because action.Target is not a UnityEngine.Object.");
            }
        }
        ...
        internal static void GetMethodDetails(string serializedMethodName, Object target, out Type declaringType,
        ...
        [SerializeField] internal PersistentArgument[] _PersistentArguments = NoArguments;
        ...
        [NonSerialized] internal MethodBase _Method;
            ...
            get
            {
                if (_Method == null)
                {
                    ...
                    if (methodName == "ctor")
                        ...
                        _Method = declaringType.GetMethod(methodName, UltEventUtils.AnyAccessBindings, null, parameters,
                            null);
                }
