...
namespace UltEvents
{
    ...
    public abstract class UltEventBase : IUltEventBase
    {
        ...
        /// <summary>
        ///     Returns true if this event has any <see cref="PersistentCallsList" /> or <see cref="DynamicCallsBase" />
        ///     registered.
        /// </summary>
        public bool HasCalls
        {
            get { return (_PersistentCalls != null && _PersistentCalls.Count > 0) || DynamicCallsBase != null; }
        }
        /************************************************************************************************************************/
        ...
        [SerializeField] internal List<PersistentCall> _PersistentCalls;
