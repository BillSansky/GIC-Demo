...
{
    /// <summary>
    ///     Allows you to expose the add and remove methods of an <see cref="UltEvent{T0, T1, T2}" /> without exposing the rest
    ///     of its
    ...
    public class UltEvent<T0, T1, T2> : UltEventBase, IUltEvent<T0, T1, T2>
    {
        ...
        ///     <seealso cref="UltEventUtils.InvokeX{T0, T1, T2}(UltEvent{T0, T1, T2}, T0, T1, T2)" />.
        /// </summary>
