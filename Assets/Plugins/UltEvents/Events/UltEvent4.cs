...
{
    /// <summary>
    ///     Allows you to expose the add and remove methods of an <see cref="UltEvent{T0, T1, T2, T3}" /> without exposing the
    ///     rest of its
    ...
    public class UltEvent<T0, T1, T2, T3> : UltEventBase, IUltEvent<T0, T1, T2, T3>
    {
        ...
        ///     <para></para>
        ///     See also: <seealso cref="InvokeSafe" /> and
        ///     <seealso cref="UltEventUtils.InvokeX{T0, T1, T2, T3}(UltEvent{T0, T1, T2, T3}, T0, T1, T2, T3)" />.
        /// </summary>
        ...
        ///     <para></para>
        ///     See also: <seealso cref="Invoke" /> and
        ///     <seealso cref="UltEventUtils.InvokeX{T0, T1, T2, T3}(UltEvent{T0, T1, T2, T3}, T0, T1, T2, T3)" />.
        /// </summary>
