...
{
    /// <summary>
    ///     Allows you to expose the add and remove methods of an <see cref="UltEvent{T0, T1}" /> without exposing the rest of
    ///     its
    ...
    public class UltEvent<T0, T1> : UltEventBase, IUltEvent<T0, T1>
    {
        ...
        ///     <seealso cref="UltEventUtils.InvokeX{T0, T1}(UltEvent{T0, T1}, T0, T1)" />.
        /// </summary>
