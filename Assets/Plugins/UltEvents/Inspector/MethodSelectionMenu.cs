...
namespace UltEvents.Editor
{
    ...
    internal static class MethodSelectionMenu
    {
        ...
        private static void GetComponent(GameObject gameObject, Type type, int targetIndex,
            out int numberOfComponentsOfType, out Component targetComponent)
        {
        ...
        private static void PopulateMenuWithMembers(Type type, BindingFlags bindings, string prefix, Object[] targets)
        {
            ...
            while (i < members.Count)
            {
                ...
                if (property != null)
                {
                    AppendGroupHeader(prefix, "Properties in ", member.DeclaringType, type, ref firstProperty,
                        ref firstSeparator);
                ...
                if (method != null)
                {
                    AppendGroupHeader(prefix, "Methods in ", member.DeclaringType, type, ref firstMethod,
                        ref firstSeparator);
        ...
        private static void AppendGroupHeader(string prefix, string name, Type declaringType, Type currentType,
            ref bool firstInGroup, ref bool firstSeparator)
        {
            if (firstInGroup)
            {
        ...
        private static void AddSelectPropertyItem(string prefix, Object[] targets, Type currentType,
            PropertyInfo property, MethodInfo getter)
        {
        ...
        private static void AddSelectMethodItem(string prefix, Object[] targets, Type currentType,
        ...
        private static MemberInfo GetNextSupportedMember(List<MemberInfo> members, ref int startIndex,
            out ParameterInfo[] parameters, out MethodInfo getter)
        {
        ...
        public static string GetMethodSignature(MethodBase method, ParameterInfo[] parameters,
            bool includeParameterNames)
        {
            ...
            var signatureCache = includeParameterNames
                ...
                : MethodSignaturesWithoutParameters;
        ...
        public static string GetMethodSignature(MethodBase method, bool includeParameterNames)
        {
            ...
            if (!signatureCache.TryGetValue(method, out signature))
            {
                signature = BuildAndCacheSignature(method, method.GetParameters(), includeParameterNames,
                    signatureCache);
            }
        ...
        private static string BuildAndCacheSignature(MethodBase method, ParameterInfo[] parameters,
            bool includeParameterNames,
