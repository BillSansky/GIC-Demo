...
namespace UltEvents
{
    ...
    public class CollisionEvents2D : MonoBehaviour
    {
        ...
        [SerializeField] private CollisionEvent2D _CollisionEnterEvent;

        /************************************************************************************************************************/

        [SerializeField] private CollisionEvent2D _CollisionExitEvent;

        /************************************************************************************************************************/

        [SerializeField] private CollisionEvent2D _CollisionStayEvent;
