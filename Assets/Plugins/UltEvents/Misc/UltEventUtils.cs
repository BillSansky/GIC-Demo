...
namespace UltEvents
{
    ...
    public static class UltEventUtils
    {
        ...
        public const BindingFlags
            AnyAccessBindings = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance |
                                BindingFlags.Static,
        ...
        ///     Calls e.Invoke if it isn't null.
        ///     <para></para>
        ///     See also: <seealso cref="UltEvent{T0, T1, T2, T3}.Invoke" /> and
        ///     <seealso cref="UltEvent{T0, T1, T2, T3}.InvokeSafe" />.
        /// </summary>
        public static void InvokeX<T0, T1, T2, T3>(this UltEvent<T0, T1, T2, T3> e, T0 parameter0, T1 parameter1,
        ...
        ///     System.Collections.Generic.List`1[[System.Single, mscorlib, Version=2.0.0.0, Culture=neutral,
        ...
        /// </summary>
        public static int AppendNameAndGenericArguments(StringBuilder text, Type type, bool fullName = true,
        ...
        ///     <para></para>
        ///     For example, passing this method info in as its own parameter would return "<see cref="UltEventUtils" />
        ///     .GetNameCS".
        ///     <para></para>
        ...
        ///     <para></para>
        ///     For example, passing this method info in as its own parameter would append "<see cref="UltEventUtils" />
        ///     .AppendName".
        ///     <para></para>
        ///     Note that when 'member' is a <see cref="Type" />, this method calls <see cref="GetNameCS(Type, bool)" /> instead.
        /// </summary>
